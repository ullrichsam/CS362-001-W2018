	...
	// Tests line 222 - 225: setRecurrence
	 ...
	 @Test
	  ...
	  //this function doesn't validate title or description
		  ...
		  assertEquals(true, appt1.getValid());  // Change to allow pass of Yokoyama bug
		  ...
		  assertTrue(appt1.getValid()); // Was false
	 ...
	 @Test
	  public void test05()  throws Throwable  {
		 Appt appt1 = new Appt(21, 30, 15, 01, 2018, "Birthday Party", "This is my birthday party.");
		  String testString1 = "\t" + 01 + "/" + 15 + "/" + 2018 +" at " + 9 + ":" + 30 + "am" + " ," + "Birthday Party" + ", " + "This is my birthday party." + "\n";
		 assertEquals(testString1, appt1.toString()); // testString1
		 ...
		 assertEquals(testString2, appt2.toString()); //testString2
	  }	
